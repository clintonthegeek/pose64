...
typedef std::vector<EmDlgItemID>		EmDlgItemIDList;

typedef long					EmDlgItemIndex;
typedef std::vector<EmDlgItemIndex>	EmDlgItemIndexList;

typedef long					EmDlgListIndex;	// Zero-based
typedef std::vector<EmDlgListIndex>	EmDlgListIndexList;
...
{
	DoSessionSaveParameters (const std::string& appName,
...
class EmDlg
{
	public:
		...
		static EmDlgItemID		DoSessionSave				(const std::string& docName,
															 Bool quitting);
		...
		static EmDlgItemID		DoCommonDialog				(const char* msg,
															 EmCommonDialogFlags);
		static EmDlgItemID		DoCommonDialog				(const std::string& msg,
															 EmCommonDialogFlags);
	...
	private:
		...
		static UInt32			PrvSelectedAppNameToIndex	(EmDatabaseList list, const std::string& appName);
		...
		static std::string PrvMenuItemText				(EmErrorHandlingOption item);
	...
	public:	// Most of these are really "Host" functions
		...
		static void				SetItemText					(EmDlgRef, EmDlgItemID, std::string);
		...
		static std::string GetItemText					(EmDlgRef, EmDlgItemID);
		...
		static void				AppendToMenu				(EmDlgRef, EmDlgItemID, const std::string&);
		...
		static void				AppendToList				(EmDlgRef, EmDlgItemID, const std::string&);
		...
		static int				GetTextHeight				(EmDlgRef, EmDlgItemID, const std::string&);
