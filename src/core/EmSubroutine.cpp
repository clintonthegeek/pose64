...
Err EmSubroutine::SetReturnVal (int32 val)
{
	...
	this->SetReturnRegInteger ((uint32)(uintptr_t) val);
...
//	}
	...
	if (fReturnType.fByRef)
		this->SetReturnRegPointer ((void*)(uintptr_t) val);
	else
		this->SetReturnRegInteger (val);
...
{
	fReturnedA0 = (uae_u32)(uintptr_t) val;
	m68k_areg (regs, 0) = (uae_u32)(uintptr_t) val;
}
...
char* EmSubroutineCPU68K::GetStackBase ()
{
	...
	return (char*)(uintptr_t) stackBase;
}
