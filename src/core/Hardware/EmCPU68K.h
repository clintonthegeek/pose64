...
typedef std::vector<Hook68KException>	Hook68KExceptionList;
typedef std::vector<Hook68KJSR>			Hook68KJSRList;
typedef std::vector<Hook68KJSR_Ind>		Hook68KJSR_IndList;
typedef std::vector<Hook68KLINK>			Hook68KLINKList;
typedef std::vector<Hook68KRTE>			Hook68KRTEList;
typedef std::vector<Hook68KRTS>			Hook68KRTSList;
typedef std::vector<Hook68KNewPC>		Hook68KNewPCList;
typedef std::vector<Hook68KNewSP>		Hook68KNewSPList;
