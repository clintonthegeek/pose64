...
// 64-BIT FIX: On LP64, 'long' is 8 bytes and int64_t IS 'long', so we'd have
// duplicate overloads. Only define long overloads on 32-bit systems.
#if ULONG_MAX == 0xFFFFFFFFUL
// 32-bit system: long is 4 bytes, separate from int64 (long long)
