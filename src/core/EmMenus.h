...
class EmMenuItem;
typedef std::vector<EmMenuItem>	EmMenuItemList;
...
class EmMenuItem
{
	public:
								...
								EmMenuItem		(const std::string&, EmCommandID);
								~EmMenuItem		(void);
	...
	private:
		std::string ExtractTitle	(const std::string&) const;
		char					ExtractShortcut	(const std::string&) const;
