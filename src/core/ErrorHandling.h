...
class Errors
{
	public:
		...
		static EmDlgItemID		ReportErrCommPort			(std::string);
		static EmDlgItemID		ReportErrSockets			(std::string);
		...
		static void				SetParameter		(const std::string& key, const char* value);
		static void				SetParameter		(const std::string& key, const unsigned char* value);
		static void				SetParameter		(const std::string& key, long);
		static void				ClearParameter		(const std::string& key);
		...
		static std::string ReplaceParameters	(StrCode templateID);
		static std::string ReplaceParameters	(StrCode templateID, ParamList& params);
		static std::string ReplaceParameters	(const std::string&, ParamList& params);
		...
		static void				GetAppName			(std::string& appNameUC,
													 std::string& appNameLC);
		static void				GetAppVersion		(std::string& appVersion);
