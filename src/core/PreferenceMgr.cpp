...
// Explicit instantiations for compound types (needed by GCC 15).
template class Preference<Configuration>;
template class Preference<DatabaseInfo>;
template class Preference<DatabaseInfoList>;
template class Preference<EmFileRefList>;
template class Preference<GremlinInfo>;
template class Preference<HordeInfo>;
template class Preference<PointType>;
template class Preference<EmPoint>;
template class Preference<RGBType>;
template class Preference<SkinNameList>;
template class Preference<SlotInfoType>;
