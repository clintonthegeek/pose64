...
// 64-BIT FIX: Changed from long to int32
...
class Hordes
{
	public:
		...
		static std::string SuggestFileName			(HordeFileType category, uint32 num = 0);
		...
		static std::string TranslateErrorCode		(UInt32 errCode);
	...
	private:
		...
		static std::string GremlinsFlagsToString	(void);
		static void				GremlinsFlagsFromString	(std::string& inFlags);
