...
typedef std::vector<EmFileCreator>	EmFileCreatorList;
...
typedef std::vector<EmFileType>		EmFileTypeList;
...
class EmFileRef
{
	public:
								...
								EmFileRef		(const std::string&);
								EmFileRef		(const EmDirRef&, const char*);
								EmFileRef		(const EmDirRef&, const std::string&);
#if PLATFORM_MAC
