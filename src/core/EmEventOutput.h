...
typedef std::vector<EmEventInfo>	EmEventInfoList;
...
class EmEventOutput
{
	...
	public:
		...
		static void				ErrorOccurred			(const std::string&);
	...
	public:
		...
		static void				OutputEvents			(std::strstream&);
		...
		static void				OutputStack				(std::strstream&, const StringList&);

	private:
		static void				OutputStartStep			(std::strstream&);
		static void				OutputKeyEventStep		(EmEventInfoList::iterator&, std::strstream&);
		static void				OutputPenEventStep		(const EmEventInfo&, std::strstream&);
		static void				OutputAppSwitchEventStep(const EmEventInfo&, std::strstream&);
		static void				OutputErrorEvent		(const EmEventInfo&, std::strstream&);
